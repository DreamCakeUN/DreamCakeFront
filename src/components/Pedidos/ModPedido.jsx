...
export class Index extends React.Component {
    ...
    /*componentDidMount(){   
        fetch('http://back.z4yross.xyz/copiar_pastel/2/', {
            method: 'GET',
            credentials:'include',
            headers: {                
            },            
    ...
    postearPastel() {
        ...
        fetch('http://back.z4yross.xyz/copiar_pastel/' + this.state.id + '/', {
            method: 'POST',
            headers: {
    ...
    editarPastel() {
        ...
        fetch('http://back.z4yross.xyz/midificar_pastel/' + this.state.id + '/', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRFToken': Cookies.get('csrftoken')
...
export class Formulario extends React.Component {
    ...
    loadPedido() {
        fetch("http://back.z4yross.xyz/pedidos/", { credentials: 'include' })
            .then(response => response.json())
    ...
    postearPedido(e) {
        ...
        let dir = this.props.origen == 1 ?
            'http://back.z4yross.xyz/editar_pedido/' + parseInt(this.state.pedido) + '/'
            : 'http://back.z4yross.xyz/crear_pedido/'
        fetch(dir, {
