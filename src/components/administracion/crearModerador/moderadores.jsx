...
export class Moderadores extends React.Component {
	...
	getAll(){
		...
		fetch("https://dream-cake.herokuapp.com/users/api/auth/all_users/", requestOptions)
	...
	updateUser(id, nombre, valor) {
		...
		fetch("https://dream-cake.herokuapp.com/users/api/auth/user/admin/" + id + "/", requestOptions)
			.then(response => response.json())
			.then(json => {
				console.log(json);
				this.getAll();
