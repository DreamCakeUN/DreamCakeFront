...
export class Admin extends React.Component {
  ...
  ws = new WebSocket("ws://http://back.z4yross.xyz/ws/pedido/")
  ...
  constructor(props) {
    ...
    this.state = {
      pedidos: [{
        ...
        foto: "http://back.z4yross.xyz/media/pedido/a_8_69UKEp6.png",
        direccion: "asdfa",
        costo: 2.0,
        aceptado: false,
        estado: 2,
  ...
  cargarPedidos(event) {
    ...
    fetch("http://back.z4yross.xyz/all_pedidos/'" + this.state.atr + "/", requestOptions)
      .then(response => response.json())
  ...
  reload() {
    this.ws = new WebSocket("ws://back.z4yross.xyz/ws/pedido/")
