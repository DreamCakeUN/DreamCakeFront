...
export class Post extends React.Component {
	...
	getCake(){
		...
		fetch('http://back.z4yross.xyz/pastel_pedido/'+this.props.post.pastel+'/', requestOptions)
			.then(res => res.json())
			.then(json => {
	...
	createComment(event){
		...
		fetch('http://back.z4yross.xyz/social/create_com/', requestOptions)
        .then(res => res.json())
        .then(json => {
	...
	copiarPastel(){
		...
		fetch('http://back.z4yross.xyz/guardar_pastel/' + id + '/', requestOptions)
        .then(res => res.json())
        .then(json => {
	...
	cargarComentarios(){
		fetch("http://back.z4yross.xyz/social/comments/" + this.props.post.id+'/')
	...
	sendLike(event){	
		event.preventDefault();
			...
			if(this.state.liked===false){
				...
				fetch('http://back.z4yross.xyz/social/like/'+ this.props.post.id + "/", requestOptions)
				.then(res => res.json())
